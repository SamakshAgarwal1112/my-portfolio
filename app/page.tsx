...
const Main = () => {
  ...
  const recentLinks = useMemo(() => {
    if (typeof window !== "undefined") {
      let recentLinksVals = localStorage.getItem("history");
  ...
  return (
    <div className="w-[70%] min-h-screen gap-16 font-[family-name:var(--font-geist-sans)]">
      <Head>
        <title>Samaksh Agarwal | Aspiring Software Developer</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={
            "Samaksh Agarwal - Aspiring Software Developer &amp; Developer Advocate"
          }
        />
        <meta
          name="description"
        ...
        <meta property="og:site_name" content="Samaksh Agarwal" />
      ...
      <main className="w-full containerCenterImage">
        <div className="container vscodecontainer mx-auto max-w-12xl w-full p-6 mb:p-12">
          <div className="flex flex-col mt-1 md:flex-row md:space-x-4">
            <div className="flex-1 mb-4 md:mb-0 ">
              <div className="p-2">
                <h2 className="text-5xl font-sans	mb-2 ">Samaksh Agarwal</h2>
                ...
                {recentLinks?.length < 1 ? (
                  ...
                  <div className="pt-1">
                    {recentLinks?.map((item: any, index: number) => (
                      <Link passHref href={item} key={`link-recent-${index}`} className="flex">
                        <p className="text-blue-500 cursor-pointer text-sm pb-2 font-sans flex justify-start gap-1 items-center">
                          {item?.slice(1)}{" "}</p>
                        <p className="text-gray-300 pl-2 text-sm ">
                          F:/SamakshAgarwal{item}
                        </p>
                      </Link>
                    ))}
                  </div>
            ...
            <div className=" flex-1">
              ...
              >
                ...
                <div className="mt-4">
                  <Link passHref target="_blank" href="https://github.com/SamakshAgarwal1112">
                    <div
                      className="cursor-pointer w-full flex justify-start items-center pl-2 pr-2 p-1 
                        rounded-sm gap-2 border-b  border-blue-500 "
                      style={{
                ...
                <div className="mt-4">
                  <Link
                    passHref
                    target="_blank"
                    href="https://twitter.com/SamakshAgg1112"
                  >
                    <div
                      className="cursor-pointer w-full flex justify-start items-center pl-2 pr-2 p-1 
                        rounded-sm gap-2 border-b  border-blue-500 "
